...
public class PullToRefreshLayout extends FrameLayout {
    ...
    private static final String LOG_TAG = "AbcPullToRefreshLayout";
    ...
    private void ensureAttacher() {
        if (mPullToRefreshAttacher == null) {
            throw new IllegalStateException("You need to setup the AbcPullToRefreshLayout before using it");
        }
    }
