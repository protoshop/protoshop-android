...
public class LoginActivity extends BaseActivity implements OnClickListener, HttpCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNameView = (EditText) findViewById(R.id.login_name_view);
                ...
                try {
                    if (response.has("status")) {
                        ...
                        if ("1".equals(status) && response.has("code")) {
                            ...
                            if ("1002".equals(code)) {
                                startActivityForResult(new Intent(getApplicationContext(), DomainActivity.class),
                                    REQUEST_DOMMAIN_CODE);
                            }
    ...
    public void onErrorResponse(VolleyError error) {
        ...
        if (error instanceof NoConnectionError) {
            new AlertDialog.Builder(this).setTitle("网络错误").setMessage("请连接DEV!")
