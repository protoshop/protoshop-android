...
public class MainActivity extends BaseActivity implements OnItemClickListener, HttpCallback,
                    ...
                    if (response.has("status")) {
                        ...
                        if ("0".equals(statusStr)) {
                            ...
                            try {
                                ...
                                Toast.makeText(getApplicationContext(), "获取Zip信息成功,开始下载ZIP文件!", Toast.LENGTH_SHORT)
                                    .show();
                                loadZipFile(model);
                            } catch (JSONException e) {
                                e.printStackTrace();
    ...
    class ProgramAdapter extends BaseAdapter {
        ImageLoader mImageLoader = new ImageLoader(ProtoshopApplication.getInstance().requestQueue, new BitmapCache());
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = View.inflate(getApplicationContext(), R.layout.program_item_layout, null);
            ...
            ProgramModel model = mModels.get(position);
