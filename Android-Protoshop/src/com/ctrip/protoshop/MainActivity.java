...
public class MainActivity extends BaseActivity implements OnItemClickListener, OnHttpListener,
                    ...
                    for (ProgramModel programModel : models) {
                        if (mProgramMap.containsKey(programModel.appID)) {
                            if (programModel.editTime.equals(mProgramMap.get(programModel.appID).editTime)) {
                                ...
                                programModel.state = new NormalState(MainActivity.this, mAdapter, mHomeScence,
                                    mProgramMap);
                            }
                        } else {
